...
public class TestDriveApi extends Activity
    ...
    private static final String BUTTON_RETURN = "Return to add board";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        returnTo = new Button(this);
        returnTo.setText(BUTTON_RETURN);
        returnTo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    parans.putString("data", mOutputText.getText().toString());
        ...
        activityLayout.addView(returnTo);
